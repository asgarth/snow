...
public class GridFormLayoutHelper implements FormLayoutHelper<GridData> {

	private static final Layout layout = new GridLayout( 2, false );

	private static final GridData CAPTION_DATA = new GridData( GridData.HORIZONTAL_ALIGN_BEGINNING );
